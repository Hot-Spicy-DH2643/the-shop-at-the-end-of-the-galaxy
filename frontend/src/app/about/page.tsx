      ...
      <main className="max-w-4xl mx-auto">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="text-lg mb-6">
            Welcome to The Shop at the End of the Galaxy - your one-stop destination 
            for all things cosmic and extraordinary!
          </p>
          ...
          <p className="mb-6">
            ...
            over 42 millennia. Whether you&apos;re looking for exotic alien artifacts, 
            rare cosmic materials, or just a good cup of Pan-Galactic Gargle Blaster, 
            we&apos;ve got you covered.
          </p>
          
          <h2 className="text-2xl font-semibold mt-8 mb-4">Our Mission</h2>
          <p className="mb-6">
            To provide the finest goods and services to beings from across the universe, 
            while maintaining the highest standards of quality and customer satisfaction. 
            No matter which dimension you&apos;re from!
          </p>
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>24/7 customer support (across all time zones and dimensions)</li>
